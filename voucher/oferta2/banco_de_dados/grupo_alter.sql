...
ALTER TABLE vendedor RENAME COLUMN idrgtri to id_regime_tributacao;
...
CREATE Table cidade (
 ...
 ALTER TABLE nota_fiscal MODIFY COLUMN end_entrega INT;
 ALTER Table nota_fiscal RENAME  COLUMN end_entrega to id_endereco;
 ALTER Table nota_fiscal ADD FOREIGN KEY (id_endereco) REFERENCES endereco(id_endereco);
