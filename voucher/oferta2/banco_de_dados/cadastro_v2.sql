...
INSERT INTO cliente (cpf, nome, rg, id_cidade, id_sexo, id_nacionalidade, fone, id_raca, id_escolaridade, id_estado_civil) VALUES
('123.456.789-01', 'Ana Silva', '605328041', 12, 1, 1, '(11) 98765-4321', 3, 2, 1),
('234.567.890-12', 'Carlos Oliveira', '338962790', 23, 2, 1, '(21) 97654-3210', 1, 4, 2),
('345.678.901-23', 'Maria Santos', '274481712', 34, 1, 2, '(31) 96543-2109', 2, 5, 3),
('456.789.012-34', 'João Pereira', '016466243', 45, 3, 1, '(41) 95432-1098', 4, 6, 4),
('567.890.123-45', 'Patrícia Costa', '802484849', 56, 2, 2, '(51) 94321-0987', 5, 7, 5),
('678.901.234-56', 'Roberto Lima', '742380159', 67, 1, 1, '(61) 93210-9876', 1, 8, 4),
('789.012.345-67', 'Fernanda Alves', '709208051', 78, 3, 2, '(71) 92109-8765', 3, 1, 3),
('890.123.456-78', 'Ricardo Martins', '136524168', 89, 2, 1, '(81) 91098-7654', 2, 3, 2),
('901.234.567-89', 'Juliana Souza', '198070659', 90, 1, 2, '(91) 90987-6543', 4, 4, 1),
('012.345.678-90', 'Eduardo Ferreira', '335117549', 101, 2, 1, '(11) 89876-5432', 5, 5, 3),
('123.456.789-10', 'Isabela Rocha', '268138165', 112, 3, 2, '(21) 88765-4321', 1, 6, 4),
('234.567.890-21', 'Gustavo Andrade', '446518363', 123, 1, 1, '(31) 87654-3210', 2, 7, 2),
('345.678.901-32', 'Tatiane Lima', '077746230', 94, 3, 2, '(41) 86543-2109', 3, 8, 4),
('456.789.012-43', 'Felipe Cardoso', '526135838', 115, 2, 1, '(51) 85432-1098', 4, 1, 5),
('567.890.123-54', 'Aline Martins', '041326868', 76, 1, 2, '(61) 84321-0987', 5, 2, 5),
('678.901.234-65', 'Marcelo Alves', '924366064', 67, 2, 1, '(71) 83210-9876', 1, 3, 2),
('789.012.345-76', 'Camila Nunes', '390323371', 58, 3, 2, '(81) 82109-8765', 2, 4, 2),
('890.123.456-87', 'Pedro Almeida', '956347792', 89, 1, 1, '(91) 81098-7654', 3, 5, 1),
('901.234.567-98', 'Sofia Lima', '000579129', 20, 2, 2, '(11) 80987-6543', 4, 6, 3),
('012.345.678-09', 'Lucas Costa', '706867486', 41, 3, 1, '(21) 79876-5432', 5, 7, 2);
...
update estado set estado='Norte' where estado regexp '^(Acre|Amapá|Amazonas|Pará|Rondônia|Roraima|Tocantins)'; -- Norte
update estado set estado='Nordeste' where estado regexp '^(Alagoas|Bahia|Ceará|Maranhão|Paraíba|Pernambuco|Piauí|Rio Grande do Norte|Sergipe)'; --  Nordeste
update estado set estado='Centro Oeste' where estado regexp '^(Goiás|Mato Grosso|Mato Grosso do Sul|Distrito Federal)'; -- Centro Oeste
update estado set estado='Sudeste' where estado regexp '^(Espírito Santo|Minas Gerais|Rio de Janeiro|São Paulo)'; -- Sudeste
update estado set estado='Sul' where estado regexp '^(Paraná|Rio Grande do Sul|Santa Catarina)'; -- Sul
update nacionalidade set nacionalidade='Fora do Brasil' where nacionalidade = 'Estrangeira';
update raca set raca='seres humanos' where id_raca <= 5;
